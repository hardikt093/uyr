      ...
      <CRow class="m-0">
         ...
         <CCol sm="12" class="px-2 btn-sticky">
            <div class="d-flex justify-content-between py-2 align-items-center">
               ...
               <div class="">
                  <CButton type="submit" class="btn_custom" :disabled="isActive">Submit
                  </CButton>
                     ...
                     <CRow class="m-0">
                           ...
                           <div class="profile-img border rounded p-1">
                            <div class="w-100">
                              <div class="profileimg mx-auto">
                               <img :src="'uploads/profile/'+doctorResult.id+'/'+doctorResult.profile_photo" v-if="doctorResult.profile_photo && imageDoc ==''">
                        ...
                        <CCol sm="6" md="4" class="px-2">
                          <label>Phone No<span class="text-danger">*</span></label>
                           <CInput v-model="formData.phone_number" v-on:blur="acceptNumber" maxlength="12" @input="acceptNumber" @keypress="onlyNumric($event)" placeholder="" :class="[ajax_error.errors.phone_number ? 'formError' : '']"/>
                  ...
                  <CRow class="m-0">
                                 ...
                                 <div class="file-upload w-100">
                                      <div class="file-select">
                                         <div class="file-select-button" id="fileName">Choose File</div>
                                          <div class="file-select-name" id="noFile" v-if="formData.certificate_awarding_university && uploadedDoc ==''">{{formData.certificate_awarding_university}}</div>
                                         <div class="file-select-name" id="noFile" v-else-if="uploadedDoc.name">{{uploadedDoc.name}}</div>
                                         <div class="file-select-name" id="noFile" v-else></div>
                                        
                                         <input type="file" name="uploadedDoc" v-on:change="cirtificatefile">
                                      </div>
                                   </div>
                                    <a v-if="formData.certificate_awarding_university" :href="'uploads/doctor/'+formData.user_id+'/'+formData.certificate_awarding_university" download><vue-fontawesome icon="download" class="px-1 ml-2" size="1.5"></vue-fontawesome> </a>
                                 </div>
                              ...
                              <div class="form-group">
                                 ...
                                 <div class="d-flex align-items-center">
                                  <div class="file-upload w-100">
                                      <div class="file-select">
                                         <div class="file-select-button" id="fileName">Choose File</div>
                                         <div class="file-select-name" id="noFile" v-if="formData.speciality_diploma && specialty ==''">{{formData.speciality_diploma}}</div>
                                         <div class="file-select-name" id="noFile" v-else-if="specialty.name">{{specialty.name}}</div>
                                         <div class="file-select-name" id="noFile" v-else></div>
                                         <input type="file" name="specialty" v-on:change="copyOfSpecialty">
                                      </div>
                                   </div>
                                   
                                   <a v-if="formData.speciality_diploma" :href="'uploads/doctor/'+formData.user_id+'/'+formData.speciality_diploma" download><vue-fontawesome icon="download" class="px-1 ml-2" size="1.5"></vue-fontawesome> </a>
                                 </div>
                                 ...
                                 <!-- <div class="attch-button">
                                  ...
                                  <div class="d-flex align-items-center">
                                   <div class="file-upload w-100">
                                      <div class="file-select">
                                         <div class="file-select-button" id="fileName">Choose File</div>
                                         <div class="file-select-name" id="noFile" v-if="formData.copy_of_registration && registration ==''">{{formData.copy_of_registration}}</div>
                                         <div class="file-select-name" id="noFile" v-else-if="registration.name">{{registration.name}}</div>
                                         <div class="file-select-name" id="noFile" v-else></div>
                                         <input type="file" name="registration" v-on:change="CopyOfRegistration">
                                      </div>
                                   </div>
                                  <a v-if="formData.copy_of_registration" :href="'uploads/doctor/'+formData.user_id+'/'+formData.copy_of_registration" download><vue-fontawesome icon="download" class="px-1 ml-2" size="1.5"></vue-fontawesome> </a>
                                 </div>
                        ...
                        <CCol sm="6" md="4" class="px-2">
                          <label>Years of experience<span class="text-danger">*</span></label>
                           <CInput placeholder="Enter Your Work Experience"   type="number" v-model="formData.experience" :class="[ajax_error.errors.experience ? 'formError' : '']"/>
...
export default {
  ...
  methods: {
    ...mapActions("Doctor/Index", ["submitDoctorUpdateForm","getdoctorData","getEquipmentList"]),
